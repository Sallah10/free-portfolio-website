        ...
        <div className='contact flex justify-center gap-20 py-16 px-16'>
          ...
          <div >
            <form action="post" className='flex flex-col gap-10'>
              ...
              <button className='flex justify-center gap-3 items-center bg-blue-900 py-3 px-3 -mt-2 md:mx-40 rounded-md text-white'>Send Message <img src={paperPlane} alt="paperPlane" /></button>
            </form>
          </div>
        </div>
      </div>
